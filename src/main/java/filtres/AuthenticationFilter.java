...
public class AuthenticationFilter implements ContainerRequestFilter {
    ...
    // Since we are not fully running in a CDI context that might support injecting
    // this perfectly
    // without more setup, we can access headers directly from the requestContext in
    // the filter method.
